...
exports.create = async (req, res) => { 
    console.log(req)
     const data_galery = {    
        ...
        fasilitas_hotel: req.body.fasilitas_hotel,    
        deskripsi: req.body.deskripsi,   
    }
    console.log("data_",data_galery)     
      await galery.create(data_galery) //menyimpan data_peserta ke table peserta    
      .then(data => {    
        res.send({    
    ...
    exports.readById = async (req, res) =>{
        ...
        await galery.findOne({where: { id: id}})   
        .then(data => {   
          res.send(data);   
        })   
        .catch(err => {   
    ...
    exports.update = async (req, res) => {
        const id = req.params.id     
        await galery.update(req.body, { where: { id: id}})     
        .then(num => {    
            num == 1 ? res.send({  
